...
/// Authentication service for Officer frontend
/// This service is hardcoded to work ONLY with officer user type
class AuthService {
  // CRITICAL: This user type is hardcoded for the officer interface
  // It ensures that only officer accounts can log in via this app
  static const String userType = 'officer';
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'password': password,
          'password2': password2,
          'user_type': userType, // Register as officer
