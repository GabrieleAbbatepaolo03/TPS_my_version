...
/// Authentication service for Customer frontend
/// This service is hardcoded to work ONLY with customer user type
class AuthService {
  // CRITICAL: This user type is hardcoded for the customer interface
  // It ensures that only customer accounts can log in via this app
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'password': password,
          'password2': password2,
          'user_type': userType, // Register as customer
